...
class KolabWAPTestHelpers(unittest.TestCase):
    ...
    def create_domain(self, domainadmin = None, withAliasDomain = False, domainname = None):
        ...
        if withAliasDomain == True:
            ...
            driver.find_element_by_xpath("//textarea[@name='associateddomain']/following-sibling::span/span[contains(@class,'listelement')]/span[contains(@class,'listactions')]/a[contains(@class,'add')]").click()
    ...
    def select_domain(self, domainname):
        ...
        elem = driver.find_element_by_xpath("//div[@id='navigation']/ul/li[contains(@class,'user')]/a")
        if not elem:
    ...
    def unlink_admin_from_domain(self, username, domainname):
        ...
        elem = driver.find_element_by_link_text("Domain Administrators")
        elem.click()
        elem = driver.find_element_by_xpath("//input[contains(@value, '" + username + "')]")
        elem.find_element_by_xpath("../span[contains(@class,'listactions')]/a[contains(@class,'reset')]").click()
        self.wait_loading(1)
